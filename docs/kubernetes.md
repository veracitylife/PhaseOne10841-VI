...
| Container image | Build or pull `phaseone:0.8.0` from this repository (`Dockerfile` at repo root) |
...
| `image.repository` / `tag` | `phaseone` / `0.8.0` | Point at your registry in prod |
